...
module.exports.run = async (bot, message, args) =>{
    ...
    if (args[0]){
        ...
        if (!args[0]){
            ...
            .addField(`Commands:`, "➖Basic: dog, cat, meme, 8ball, coinflip, ,rps, pp, ping, uptime\n➖Informative: info, userinfo, serverinfo\n➖Moderation: kick, mute, ban, unmute, unban, clear, prefix, say, welcome, modlog")
